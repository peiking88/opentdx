...
ex_hosts = [
    ...
    # 以下为 connect.cfg 未收录但历史可用的补充服务器
    ("扩展市场深圳双线3(备)", "43.139.173.246", 7727),
    ("扩展市场深圳双线4(备)", "159.75.90.107", 7727),
    ("扩展市场深圳双线5(备)", "106.52.170.195", 7727),
    ("扩展市场广州双线3(备)", "175.24.47.69", 7727),
    ("扩展市场上海双线1(备)", "150.158.9.199", 7727),
    ("扩展市场上海双线2(备)", "150.158.20.127", 7727),
    ("扩展市场上海双线3(备)", "49.235.119.116", 7727),
    ("扩展市场上海双线4(备)", "49.234.13.160", 7727),
    ("扩展市场广州双线4", "123.60.173.210", 7727),
